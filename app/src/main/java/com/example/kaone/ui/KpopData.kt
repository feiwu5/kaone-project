...
object KpopData {
    ...
    val groupMembersData = mapOf(
        ...
        "ALPHA DRIVE ONE|ALD1|https://drive.google.com/uc?export=view&id=1tL4TgCy31rS6BKYNIOxy0phNp-UprWrK" to listOf("Junseo|金俊抒", "Arno|張家豪", "Leo|李理悟", "Geonwoo|金虔佑", "Sangwon|李相沅", "Xinlong|賀鑫隆", "Anxin|周安信", "Sanghyeon|鄭相炫"),
        "ARTMS||https://drive.google.com/uc?export=view&id=1LzBw1bNQJdKwkRcw_M5lprokmStF8xBV" to listOf("JinSoul|眞率","HaSeul|夏瑟","Kim Lip","HeeJin|姬振","Choerry"),
